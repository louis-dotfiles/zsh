...
# and further customized for my own use cases.
#
# Authors:
...
COMPLETIONS_DIR="${0:h}"
# source "$COMPLETIONS_DIR/ssh.zsh"
fpath=("$COMPLETIONS_DIR/test" $fpath)
...
# This is arguably the most important setting for an ergonomic completion
# experience.
